...
public class ScavaApiAndQnARecommendationUsageEvent extends Event implements IDisableableEvent{

	
	public ScavaApiAndQnARecommendationUsageEvent() {
		// TODO Auto-generated constructor stub
	}
	
	@Override
	public String toString() {
		return "Date: " + date + " VertexType: " + VertexType.SCAVA_API_AND_QNA_USAGE_EVENT;
	}
	
	
	@Override
	public Vertex toNode(VertexAllocator allocator) throws MetricException {
		Vertex eventVertex = allocator.insertVertex("event", new VertexProperty("VertexType", VertexType.SCAVA_API_AND_QNA_USAGE_EVENT),
