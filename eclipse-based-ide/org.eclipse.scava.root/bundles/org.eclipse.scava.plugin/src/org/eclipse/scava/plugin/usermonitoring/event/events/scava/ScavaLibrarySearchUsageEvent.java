...
public class ScavaLibrarySearchUsageEvent extends Event implements IDisableableEvent{

	
	public ScavaLibrarySearchUsageEvent() {
		// TODO Auto-generated constructor stub
	}
	
	@Override
	public String toString() {
		return "Date: " + date + " VertexType: " + VertexType.SCAVA_LIBRARY_SEARCH_USAGE_EVENT;
	}
	
	
	@Override
	public Vertex toNode(VertexAllocator allocator) throws MetricException {
		Vertex eventVertex = allocator.insertVertex("event", new VertexProperty("VertexType", VertexType.SCAVA_LIBRARY_SEARCH_USAGE_EVENT),
